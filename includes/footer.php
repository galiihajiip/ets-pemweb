    <!-- Floating Buttons BLOK 8.0 -->
    <div class="floating-btn">
        <a href="#top" id="backToTop" class="btn-back-to-top active" title="Back to Top">↑</a>
    ...
    <footer class="py-16 mt-24" style="background-color: #2d3a1e; color: #c8dca0;">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4">
                    <h3 class="playfair text-white text-3xl font-bold mb-4">🍃 KOENCHIPS</h3>
                ...
                <div class="col-lg-4">
                    ...
                    <p class="text-sm">📍 Sidoarjo, Jawa Timur<br>📞 +62 822-6558-8823<br>✉️ hello@koenchips.id</p>
                </div>
            </div>
